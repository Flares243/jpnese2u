...
import 'package:jpnese2u/ui/capture_translate/token_translation/tokens_translation.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          BlocBuilder<SentenceSelectionCubit, SentenceSelectionState>(
            builder: (_, state) {
              final selectedTokens = sentence.tokens
                  .where((token) => state.contains(token.id))
                  .toList();

              return TokensTranslationView(tokens: selectedTokens);
            },
          ),
        ],
      ),
